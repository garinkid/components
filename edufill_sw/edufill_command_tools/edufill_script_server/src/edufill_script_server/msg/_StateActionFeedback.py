...
class StateActionFeedback(roslib.message.Message):
  ...
  _type = "edufill_script_server/StateActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','edufill_script_server/StateFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = edufill_script_server.msg.StateFeedback()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = edufill_script_server.msg.StateFeedback()
