...
(cl:defmethod cl:initialize-instance :after ((m <ScriptState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScriptState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name edufill_script_server-msg:<ScriptState> is deprecated: use edufill_script_server-msg:ScriptState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:header-val is deprecated.  Use edufill_script_server-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:number-val is deprecated.  Use edufill_script_server-msg:number instead.")
  (number m))

(cl:ensure-generic-function 'function_name-val :lambda-list '(m))
(cl:defmethod function_name-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:function_name-val is deprecated.  Use edufill_script_server-msg:function_name instead.")
  (function_name m))

(cl:ensure-generic-function 'component_name-val :lambda-list '(m))
(cl:defmethod component_name-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:component_name-val is deprecated.  Use edufill_script_server-msg:component_name instead.")
  (component_name m))

(cl:ensure-generic-function 'parameter_name-val :lambda-list '(m))
(cl:defmethod parameter_name-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:parameter_name-val is deprecated.  Use edufill_script_server-msg:parameter_name instead.")
  (parameter_name m))

(cl:ensure-generic-function 'full_graph_name-val :lambda-list '(m))
(cl:defmethod full_graph_name-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:full_graph_name-val is deprecated.  Use edufill_script_server-msg:full_graph_name instead.")
  (full_graph_name m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:state-val is deprecated.  Use edufill_script_server-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'error_code-val :lambda-list '(m))
(cl:defmethod error_code-val ((m <ScriptState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader edufill_script_server-msg:error_code-val is deprecated.  Use edufill_script_server-msg:error_code instead.")
  (error_code m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ScriptState>)))
  ...
  "edufill_script_server/ScriptState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ScriptState)))
  "Returns string type for a message object of type 'ScriptState"
  "edufill_script_server/ScriptState")
