...
(cl:defclass <StateGoal> (roslisp-msg-protocol:ros-message)
  ((state
    :reader state
    :initarg :state
    :type edufill_script_server-msg:ScriptState
    :initform (cl:make-instance 'edufill_script_server-msg:ScriptState)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <StateGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StateGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name edufill_script_server-msg:<StateGoal> is deprecated: use edufill_script_server-msg:StateGoal instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StateGoal>)))
  ...
  "edufill_script_server/StateGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StateGoal)))
  "Returns string type for a message object of type 'StateGoal"
  "edufill_script_server/StateGoal")
