...
#include <edufill_baseplacement/BaseScanLinearRegression.h>
#include <iostream>

using namespace edufill_baseplacement;
...
int main(int argc, char** argv)
{
  ...
  OrientToLaserReadingAction orientAction(n, "/edufill_baseplacement/scan_front_orientation", cmd_vel_name, service_name);
