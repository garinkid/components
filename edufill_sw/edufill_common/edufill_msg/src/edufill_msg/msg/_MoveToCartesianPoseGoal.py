"""autogenerated by genpy from edufill_msg/MoveToCartesianPoseGoal.msg. Do not edit."""
import sys
...
class MoveToCartesianPoseGoal(genpy.Message):
  _md5sum = "f604333b1c42a458d8e70c980fbc1eda"
  _type = "edufill_msg/MoveToCartesianPoseGoal"
...
"""
  __slots__ = ['goal','cartesian_stiffness','cartesian_damping']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       goal,cartesian_stiffness,cartesian_damping
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.cartesian_stiffness)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.cartesian_stiffness))
      length = len(self.cartesian_damping)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.cartesian_damping))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.cartesian_stiffness = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.cartesian_damping = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.cartesian_damping.tostring())
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.cartesian_stiffness = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.cartesian_damping = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
