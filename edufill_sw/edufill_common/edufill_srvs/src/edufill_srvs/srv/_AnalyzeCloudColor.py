"""autogenerated by genmsg_py from AnalyzeCloudColorRequest.msg. Do not edit."""
...
class AnalyzeCloudColorRequest(roslib.message.Message):
  _md5sum = "96cec5374164b3b3d1d7ef5d7628a7ed"
  _type = "edufill_srvs/AnalyzeCloudColorRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AnalyzeCloudColorRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genmsg_py from AnalyzeCloudColorResponse.msg. Do not edit."""
import roslib.message
import struct


class AnalyzeCloudColorResponse(roslib.message.Message):
  _md5sum = "b73a456e20e2543281b5f8315a5249d8"
  _type = "edufill_srvs/AnalyzeCloudColorResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AnalyzeCloudColorResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2fQ.pack(_x.mean, _x.median, _x.points))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mean, _x.median, _x.points,) = _struct_2fQ.unpack(str[start:end])
      return self
    except struct.error as e:
      raise roslib.message.DeserializationError(e) #most likely buffer underfill
...
class AnalyzeCloudColor(roslib.message.ServiceDefinition):
  _type          = 'edufill_srvs/AnalyzeCloudColor'
  _md5sum = 'b874014b9449583ee9c5e89983c8a0a8'
  _request_class  = AnalyzeCloudColorRequest
  _response_class = AnalyzeCloudColorResponse
