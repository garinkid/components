...
#include <edufill_nxt_geometrical_solution/ik_service_msg.h>
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "nxt_ik_test_client");
	...
	// Service
  ros::NodeHandle nh_;
  ros::ServiceClient client = nh_.serviceClient<edufill_nxt_geometrical_solution::ik_service_msg>("edufill_nxt_geometrical_solution/ik_service_msg");
  edufill_nxt_geometrical_solution::ik_service_msg srv;
  ...
  {
    ROS_ERROR("Failed to call service edufill_nxt_geometrical_solution/ik_service_msg");
    return -1;
  }
