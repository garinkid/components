"""autogenerated by genmsg_py from MoveToCartesianPoseActionGoal.msg. Do not edit."""
...
class MoveToCartesianPoseActionGoal(roslib.message.Message):
  _md5sum = "afd96e4a34a69ea5ef07941841344f11"
  _type = "edufill_arm_navigation/MoveToCartesianPoseActionGoal"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalID','edufill_arm_navigation/MoveToCartesianPoseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = edufill_arm_navigation.msg.MoveToCartesianPoseGoal()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = edufill_arm_navigation.msg.MoveToCartesianPoseGoal()
